<div  class="max-w-3xl p-6 mx-auto bg-white rounded-lg shadow">
 <h2 class="mb-6 text-2xl font-bold text-gray-700">Add FC Admin</h2>
    <form wire:submit="register">
        ...
        <div class="mt-4">
            ...
            <x-text-input wire:model="email" id="email" class="block w-full mt-1 cursor-text" type="email" name="email" required autocomplete="username" />
