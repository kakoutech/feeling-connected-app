<div class="max-w-full p-6 mx-auto space-y-6 bg-white rounded-lg shadow">
    ...
    <a href="{{ route('dashboard.venue.add') }}">
                ...
                <tr class="transition-colors duration-200 hover:bg-gray-100">
                    ...
                    <td class="px-6 py-4 text-center text-gray-700 border-b border-gray-300">
                        <div class="flex justify-center space-x-8">
                            <!-- Edit Button -->
                            <a class="text-blue-500 hover:text-blue-700" href="{{ route('dashboard.venue.edit', ['id' => $row['id']]) }}"
                               >
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor" class="w-5 h-5">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M15.232 5.232a4.5 4.5 0 016.364 6.364l-11.778 11.778a2 2 0 01-.796.494l-5.64 1.416a1 1 0 01-1.208-1.208l1.416-5.64a2 2 0 01.494-.796L13.768 9.768a4.5 4.5 0 010-6.364z" />
                                </svg>
                            </a>
                            <!-- Delete Button -->

                            <button type="submit"  wire:click='deleteVenue({{ $row['id'] }})'
