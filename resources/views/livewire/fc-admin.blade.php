<div class="max-w-full p-6 mx-auto space-y-6 bg-white rounded-lg shadow">
    ...
    <a href="{{ route('dashboard.fc_admin.add') }}">
        <x-primary-button>Create FC Admin</x-primary-button>
    </a>
                    ...
                    <td class="px-6 py-4 text-center text-gray-700 border-b border-gray-300">
                        <div class="flex justify-center space-x-4">
                            ...
                            <a class="text-blue-500 hover:text-blue-700"
                             href="{{ route('dashboard.fc_admin.edit', ['id' => $row['id']]) }}"
                               >
                            ...
                            <!-- Delete Button -->
                            <button type="submit"     wire:click='deleteUser({{ $row['id'] }})'
